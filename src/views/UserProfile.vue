            ...
            <div class="container-fluid d-flex align-items-center">
                <div class="row">
                    <div class="col-lg-7 col-md-10">
                        ...
                        <p class="text-white mt-0 mb-5">Esta es tu página de perfil donde podrás visualizar los datos referente a su cuenta. Puedes gestionar tus matrículas a los ciclos que manejamos!!</p>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-3 order-lg-2">
                                <div class="card-profile-image">
                                    <a href="#">
                                        <img src="img/theme/user.png" class="rounded-circle">
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body pt-0 pt-md-4">
                            ...
                            <div class="text-center">
                                ...
                                <div class="h5 font-weight-300">
                                    <i class="ni location_pin mr-2"></i>Provincia: {{estudiante.provincia}}
                                </div>
                                <div class="h5 font-weight-300">
